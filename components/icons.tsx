...
export const GoogleIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg className={className} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
        <path fill="#4285F4" d="M43.611,20.083H42V20H24v8h11.303c-1.649,4.657-6.08,8-11.303,8c-6.627,0-12-5.373-12-12 s5.373-12,12-12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4C12.955,4,4,12.955,4,24 s8.955,20,20,20s20-8.955,20-20C44,22.659,43.862,21.35,43.611,20.083z"></path>
        <path fill="#34A853" d="M43.611,20.083L43.594,20H24v8h11.303c-1.649,4.657-6.08,8-11.303,8V44c5.268,0,10.046-1.953,13.591-5.639 l-5.657-5.657C34.046,28.659,38.271,24.816,43.611,20.083z"></path>
        <path fill="#FBBC05" d="M12.31,16.691l-5.657,5.657C8.283,23.345,10.046,24,12,24h12c0,0-2.36-3.832-6.917-6.917 C15.184,16.832,13.684,16.691,12.31,16.691z"></path>
        <path fill="#EA4335" d="M43.611,20.083L24,20v-8c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4 v8c5.268,0,10.046,1.953,13.591,5.639C34.046,20.659,43.611,20.083,43.611,20.083z"></path>
    </svg>
);
